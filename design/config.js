...
//canvas layers
var canvas_back = document.getElementById("canvas_back") != null ? document.getElementById("canvas_back").getContext("2d") : undefined;		//layer for grid/transparency
var canvas_front = document.getElementById("canvas_front") != null ? document.getElementById("canvas_front").getContext("2d") : undefined;		//tmp layer
var canvas_grid = document.getElementById("canvas_grid") != null ? document.getElementById("canvas_grid").getContext("2d") : undefined;		//grid layer
var canvas_preview = document.getElementById("canvas_preview") != null ? document.getElementById("canvas_preview").getContext("2d") : undefined;	//mini preview
