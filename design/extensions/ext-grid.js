...
svgEditor.addExtension('view_grid', function() { 'use strict';
	...
	/************************************************************************/
    var cbPattern = svgdoc.createElementNS(NS.SVG, 'pattern');
    assignAttributes(cbPattern, {
        'id': 'cbpattern',
        'patternUnits': 'userSpaceOnUse',
        'x': 0,
        'y': 0,
    ...
    var rect1 = svgdoc.createElementNS(NS.SVG, 'rect');
    assignAttributes(rect1, {
        'fill': 'rgba(159, 188, 191, 0.4)',
        'x': 0,
        'y': 0,
        'width': 12,
        'height': 12,
    ...
    var rect2 = svgdoc.createElementNS(NS.SVG, 'rect');
    ...
    cbPattern.appendChild(rect1);
    cbPattern.appendChild(rect2);

    var rect3 = svgdoc.createElementNS(NS.SVG, 'rect');
    assignAttributes(rect3, {
        'fill': 'url(#cbpattern)',
        'x': 0,
        'y': 0,
        'width': '100%',
    ...
    var canvasCb = svgdoc.createElementNS(NS.SVG, 'svg');
    assignAttributes(canvasCb, {
        'id': 'canvasCheckboard',
        'width': '100%',
        'height': '100%',
        'x': 0,
    ...
    canvBG.append(canvasCb);

    $('#canvasCheckboard').append(cbPattern);
    $('#canvasCheckboard').append(rect3);
	...
	return {
		name: 'view_grid',
		svgicons: null,//svgEditor.curConfig.extPath + 'grid-icon.xml',
