	...
	function(options) {
		...
		return this.each( function() {
            ...
            cancelClicked = function() {
                ...
                $.isFunction($this.updateCallback) && $this.updateCallback($this.initPaint);
				...
				onUpdate = function()
				{
                    ...
                    $.isFunction($this.updateCallback) && $this.updateCallback($this.paint);
				};

            $('#color_picker_background').unbind('click').bind('click' ,clickOutsideColorPicker);

            function clickOutsideColorPicker()
            {
                cancelClicked();
            }
            ...
            $this.html('<ul class="jGraduate_tabs">' +
            			...
            			'<div id="jGraduate_gradPick_id" class="jGraduate_gradPick"></div>' +
...
// 			(function() {
            ...
            $('#jGraduate_gradPick_id').bind('mousemove' , function()
            {
                $this.paint.type = curType;
                $this.paint[curType] = curGradient.cloneNode(true);;
                $this.paint.solidColor = null;
